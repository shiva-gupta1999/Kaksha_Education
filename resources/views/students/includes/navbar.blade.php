        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="{{url('assets/images/student')}}/{{$student[0]['pic']}}" alt="{{$student[0]['student_name']}}"/>
            </a>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-12">
                        ...
                        <form action="{{url('/student/changepassword')}}" class="needs-validation" id="" method="POST" enctype="multipart/form-data">
                          @csrf
                          <div class="row">
                            <div class="col-md-12">
