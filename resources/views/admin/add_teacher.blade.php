...
<div class="content-wrapper">
  ...
  <nav aria-label="breadcrumb" class="main-breadcrumb mt-3">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0)">Add new Teacher</a></li>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin">
          <div class="d-flex justify-content-between align-items-center">
            <div>
              <h4 class="font-weight-bold mb-0">Kaksha-Education Add Teacher</h4>
            </div>
            <div>
        ...
        <div class="container">
            ...
            <div class="card">
              <div class="card-header bg-info">
                <h3 class="text-light">Add Teachers</h3>
              </div>
                <div class="card-body">
                  <form action="{{url('/admin/teachers/add')}}" class="needs-validation" id="" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                      <div class="col-md-12">
