...
<html lang="en">
<head>
  <title>KakshaEducation || Admin Login</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="icon" type="image/favicon.png" href="{{url('assets/images/logo/logo.png')}}">
            ...
            <div class="card-footer row" >
                ...
                <section class="text-center">
                    ...
                    <a
                        ...
                        href="https://www.instagram.com/kaksha_education2011/?utm_medium=copy_links"
                        role="button"
                        target="_blank"
